...
const DesktopTwelvePage = () => {
  const [group745value, setGroup745value] = React.useState("");
  const [group745value1, setGroup745value1] = React.useState("");
  const [group745value2, setGroup745value2] = React.useState("");
  const sliderRef = React.useRef(null);
  const [sliderState, setsliderState] = React.useState(0);
  const [group745value3, setGroup745value3] = React.useState("");

  return (
    <>
      <div className="bg-gray-100 flex flex-col font-inter items-center justify-end mx-auto pt-[37px] w-full">
        <div className="flex flex-col items-center justify-start w-full">
          <div className="h-[789px] md:px-5 relative w-full">
            <div className="bg-black-900_7e flex flex-col gap-6 items-center justify-center mb-[undefinedpx] mt-auto mx-auto p-[68px] md:px-10 sm:px-5 w-full z-[1]">
              <Text
                className="mt-[212px] sm:text-[39px] md:text-[45px] text-[49px] text-white-A700"
              ...
              <Slider
                ...
                ref={sliderRef}
                className="font-poppins mb-[129px] w-full"
                items={[...Array(9)].map(() => (
                  <React.Fragment key={Math.random()}>
                    <div className="bg-gray-400_99 flex flex-col items-center justify-end mx-2.5 p-[21px] sm:px-5 rounded-[10px]">
                      <div className="flex flex-col items-center justify-start mt-2.5 w-[92%] md:w-full">
                        <div className="flex flex-col gap-[34px] items-center justify-start w-full">
                          ...
                          <div className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[13px] rounded-[21px] w-full">
                            ...
                            <Input
                              name="group745"
                              placeholder="Search"
                              value={group745value3}
                              onChange={(e) => setGroup745value3(e)}
                              className="font-medium p-0 placeholder:text-white-A700 text-center text-white-A700 text-xs w-full"
                              ...
                              suffix={
                                <CloseSVG
                                  className="cursor-pointer h-[13px] my-auto"
                                  onClick={() => setGroup745value3("")}
                                  fillColor="#ffffff"
                                  style={{
                                    visibility:
                                      group745value3?.length <= 0
                                        ? "hidden"
                                        : "visible",
                                  }}
                                  height={13}
            ...
            <Text
              className="mb-[-0.5px] ml-[145px] sm:text-[41px] md:text-[47px] text-[55px] text-light_blue-900 z-[1]"
              size="txtInterMedium55"
            >
              LOGO
            </Text>
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-center mb-[undefinedpx] ml-auto mr-[272px] mt-5 w-[48%] z-[1]">
              <Text
                className="text-[19px] text-light_blue-900"
                size="txtInterMedium19"
              >
                BUY
              </Text>
              <Text
                className="md:ml-[0] ml-[55px] text-[17px] text-black-900"
                size="txtInterRegular17"
              >
                RENT
              </Text>
              <Text
                className="md:ml-[0] ml-[47px] text-[17px] text-black-900"
                size="txtInterRegular17"
              >
                PROJECTS
              </Text>
            ...
            <Img
              className="h-[723px] mt-auto mx-auto object-cover w-full"
              src="images/img_rectangle44.png"
              alt="rectangleFortyFour"
            />
          </div>
          <div className="flex md:flex-col flex-row gap-[17px] items-center justify-start max-w-[1147px] mt-[83px] mx-auto md:px-5 w-full">
          ...
          <div className="font-poppins md:h-[228px] h-[68px] mt-40 md:px-5 relative w-[52%] md:w-full">
          ...
          <div className="flex flex-col font-poppins md:gap-10 gap-[180px] items-center justify-start max-w-[1147px] mt-[50px] mx-auto md:px-5 w-full">
        ...
        <div className="font-poppins h-[3192px] md:h-[5067px] sm:h-[5257px] mt-[76px] md:px-5 relative w-full">
          <div className="flex flex-col h-full items-center justify-start m-auto w-full">
            <div className="flex flex-col md:gap-10 gap-[577px] items-center justify-start w-full">
              <div className="flex flex-col items-start justify-start w-[81%] md:w-full">
                <div className="flex md:flex-col flex-row gap-[15px] items-center justify-between ml-0.5 md:ml-[0] w-[99%] md:w-full">
                ...
                <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between md:ml-[0] ml-[47px] mt-[23px] w-[93%] md:w-full">
                ...
                <div className="font-inter md:gap-10 gap-[333px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-start justify-between md:ml-[0] ml-[151px] mt-[19px] w-[73%] md:w-full">
                  <Text
                ...
                <div className="h-[598px] md:h-[884px] md:ml-[0] ml-[487px] mt-[286px] relative w-[58%] md:w-full">
                ...
                <Text
                  className="mt-[38px] sm:text-[32px] md:text-[38px] text-[42px] text-deep_orange-A200"
                  size="txtPoppinsBold42"
                >
                  POWER OF Decysions.
                </Text>
              </div>
              <div className="md:h-[2141px] h-[884px] relative w-full">
                <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[1%] w-[78%]">
                  <div className="flex md:flex-col flex-row gap-[33px] items-start justify-between w-full">
                    <Img
                      className="h-[498px] md:h-auto md:mt-0 mt-[38px] object-cover"
                      src="images/img_image25.png"
                      alt="imageTwentyFive"
                    />
                    <div className="flex flex-col justify-start">
                      <Text
                        className="md:ml-[0] ml-[109px] md:text-2xl sm:text-[22px] text-[26px] text-blue_gray-900"
                        size="txtPoppinsRegular26"
                      >
                        Store of intenax
                      </Text>
                      <Text
                        className="mt-3.5 sm:text-[32px] md:text-[38px] text-[42px] text-deep_orange-A200"
                        size="txtInterBold42"
                      >
                        ____
                      </Text>
                      <Text
                        className="ml-20 md:ml-[0] sm:text-[32px] md:text-[38px] text-[42px] text-deep_orange-A200"
                        size="txtPoppinsBold42"
                      >
                        Stength of plannig .
                      </Text>
                ...
                <div className="absolute bg-gray-800 h-[327px] right-[10%] top-[15%] w-[47%]"></div>
                <div className="absolute flex flex-col h-full inset-[0] justify-center m-auto pt-[161px] w-full">
                  ...
                  <Img
                    ...
                    alt="imageTwentySix"
                  />
                  <div className="font-inter md:h-[1070px] h-px md:ml-[0] ml-[246px] mr-[370px] mt-80 relative w-[58%] md:w-full">
                    <div className="h-[750px] mx-auto w-full">
                      <div className="bg-white-A700 h-[750px] m-auto w-full"></div>
                      <Text
                    ...
                    <div className="absolute flex flex-col md:gap-10 gap-[145px] justify-end right-[1%] top-full w-[83%]">
                      <Text
                        ...
                        size="txtInterBold42"
                      >
                        Solutions That Fits Every Status .
                      </Text>
                      <div className="flex flex-col font-poppins md:gap-10 gap-[227px] items-start justify-start md:ml-[0] ml-[17px] mr-[120px] w-4/5 md:w-full">
                        <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-full">
                          <Text
                        ...
                        <Input
                          ...
                          className="font-medium leading-[normal] p-0 placeholder:text-white-A700 text-left text-xl w-full"
          ...
          <div className="absolute flex flex-col justify-start left-[4%] top-[23%] w-[86%]">
            <Text
              className="md:ml-[0] ml-[469px] sm:text-[35px] md:text-[41px] text-[45px] text-orange-700"
              size="txtPoppinsMedium45Orange700"
            >
              Our Properties
            </Text>
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[84px] mt-[193px] w-[36%] md:w-full">
              <Text className="text-gray-700 text-xl" size="txtPoppinsMedium20">
                BUY A HOME
              </Text>
              <Text
                className="mt-[5px] sm:text-[31px] md:text-[37px] text-[41px] text-black-900 w-full"
                size="txtPoppinsSemiBold41"
              >
                Find, Buy & Own Your Dream Home
              </Text>
              <Text
                className="leading-[38.00px] md:ml-[0] ml-[5px] text-blue_gray-900 text-lg w-[99%] sm:w-full"
            ...
            <div className="flex md:flex-col flex-row font-inter md:gap-5 items-start justify-evenly mt-[391px] w-full">
              <Text
                className="sm:text-[32px] md:text-[38px] text-[42px] text-deep_orange-A200"
                size="txtInterBold42"
              >
              ...
              <div className="font-poppins h-[498px] relative w-[94%] md:w-full">
                <Img
        ...
        <div className="flex flex-col justify-start mt-[317px] w-full">
          <Text
            className="md:ml-[0] ml-[289px] sm:text-[32px] md:text-[38px] text-[42px] text-deep_orange-A200"
            size="txtInterBold42"
          >
            _____Providing Customized Design
          </Text>
          <Text
            className="leading-[37.00px] md:ml-[0] ml-[385px] mt-[167px] text-gray-700 text-xl w-[44%] sm:w-full"
          ...
          <Text
            className="leading-[37.00px] md:ml-[0] ml-[401px] mt-[47px] text-gray-700 text-xl w-[43%] sm:w-full"
            size="txtPoppinsRegular20Gray700"
          >
            <>
          ...
          <div className="flex flex-col items-center justify-start mt-[416px] w-full">
            ...
            <Text
              className="mt-[141px] md:text-2xl sm:text-[22px] text-[26px] text-blue_gray-900"
              size="txtPoppinsRegular26"
            >
              Quality Of WORK
            </Text>
            <Text
              className="mt-2 sm:text-[32px] md:text-[38px] text-[42px] text-deep_orange-A200"
              size="txtInterBold42"
            >
              ____ Stats Are Numbers
            </Text>
            <div className="flex md:flex-col flex-row font-inter gap-4 items-start justify-start max-w-[1137px] mt-[97px] mx-auto md:px-5 w-full">
            ...
            <Text
              className="mt-[134px] md:text-2xl sm:text-[22px] text-[26px] text-blue_gray-900"
              size="txtPoppinsRegular26"
            >
              PASSIONATE TEAM
            </Text>
            <div className="flex sm:flex-col flex-row gap-[9px] items-start justify-start mt-[17px] md:px-5 w-[34%] md:w-full">
              <Text
            ...
            <div className="flex md:flex-col flex-row font-poppins gap-3.5 items-center justify-start max-w-[1138px] mt-[115px] mx-auto md:px-5 w-full">
            ...
            <div className="font-inter h-[1134px] md:h-[1234px] mt-[127px] md:px-5 relative w-[90%] md:w-full">
              <div className="absolute h-[1134px] md:h-[627px] sm:h-[680px] inset-y-[0] left-[0] my-auto w-[1135px] md:w-full">
                <div className="absolute md:h-[627px] sm:h-[680px] h-[788px] left-[0] top-[0] w-[69%] md:w-full">
                  <div className="absolute flex flex-col font-poppins inset-x-[0] items-center justify-start mx-auto top-[0] w-[98%]">
                    <div className="flex flex-col justify-start w-full">
                      <Text
                        className="md:ml-[0] ml-[450px] md:text-2xl sm:text-[22px] text-[26px] text-blue_gray-900"
                        size="txtPoppinsRegular26"
                      >
                        WHAT’S HAPPING
                      </Text>
                      <div className="flex sm:flex-col flex-row gap-[9px] items-end justify-end md:ml-[0] ml-[322px] mt-[9px] w-[57%] md:w-full">
                        <Text
                      ...
                      <Img
                        className="h-[493px] sm:h-auto mr-[285px] mt-8 object-cover w-[62%] md:w-full"
                  ...
                  <Img
                    className="absolute h-[290px] object-cover right-[0] top-[17%] w-[38%]"
                    src="images/img_image29.png"
                    alt="imageTwentyNine"
                  />
                  <Img
                    className="absolute bottom-[5%] h-[281px] object-cover right-[0] w-[38%]"
                    src="images/img_image30.png"
                    alt="imageThirty"
                  />
                  <Button
                    className="absolute bottom-[16%] cursor-pointer font-bold font-inter leading-[normal] left-[4%] min-w-[246px] sm:text-[21px] md:text-[23px] text-[25px] text-center"
                    shape="square"
                    color="deep_orange_A200"
                    size="lg"
                    variant="fill"
                  ...
                  <div className="absolute bottom-[0] flex flex-col font-poppins gap-[13px] items-start justify-start left-[0]">
                    <Text
                ...
                <div className="absolute flex flex-col items-start justify-start right-[0] top-[12%] w-[30%]">
                  <div className="bg-deep_orange-A200 flex flex-col font-inter items-center justify-end md:ml-[0] ml-[3px] p-4">
                    <Text
                  ...
                  <div className="bg-deep_orange-A200 flex flex-col font-inter items-center justify-end mt-[104px] p-4">
                    <Text
                      className="mt-[3px] sm:text-[21px] md:text-[23px] text-[25px] text-white-A700"
                      size="txtInterBold25WhiteA700"
                    >
                ...
                <div className="absolute bottom-[0] flex flex-col inset-x-[0] items-start justify-start mx-auto w-full">
                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start mt-[194px] w-[84%] md:w-full">
                    <Text
                  ...
                  <div className="flex sm:flex-col flex-row gap-[21px] items-center justify-end md:ml-[0] ml-[540px] w-[53%] md:w-full">
                    <div className="border border-black-900 border-solid h-[62px] w-[68%]"></div>
                    <div className="bg-orange-300 flex flex-col items-center justify-start p-[15px]">
                      <Text
              ...
              <Img
                className="absolute h-[1107px] inset-y-[0] my-auto object-cover right-[0] w-[67%]"
                src="images/img_capture6.png"
                alt="captureSix"
              />
            </div>
