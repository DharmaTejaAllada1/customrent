...
import DesktopThirteenImage26 from "components/DesktopThirteenImage26";
...
const DesktopThirteenPage = () => {
  ...
  const [groupthirtysevevalue, setGroupthirtysevevalue] = React.useState("");

  return (
    <>
      <div className="bg-gray-100 flex flex-col font-inter items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          <div className="flex flex-col gap-[26px] items-start justify-start max-w-[1145px] mx-auto md:px-5 w-full">
                    ...
                    <div className="flex flex-col gap-[34px] items-center justify-start mt-2.5 w-[92%] md:w-full">
                      ...
                      <div className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[13px] rounded-[21px] w-full">
                        ...
                        <Input
                          ...
                          placeholder="Search"
                          value={groupthirtysevevalue}
                          onChange={(e) => setGroupthirtysevevalue(e)}
                          className="!placeholder:text-white-A700 !text-white-A700 font-medium p-0 text-center text-xs w-full"
                          wrapClassName="flex md:flex-1 md:ml-[0] ml-[19px] rounded-br-[40px] rounded-tr-[40px] w-[15%] md:w-full"
                          prefix={
                          ...
                          suffix={
                            <CloseSVG
                              fillColor="#ffffff"
                              className="cursor-pointer h-[13px] my-auto"
                              onClick={() => setGroupthirtysevevalue("")}
                              style={{
                                visibility:
                                  groupthirtysevevalue?.length <= 0
                                    ? "hidden"
                                    : "visible",
                              }}
                              height={13}
        ...
        <div className="font-poppins h-[3192px] md:h-[5067px] sm:h-[5257px] mt-[76px] md:px-5 relative w-full">
          <div className="flex flex-col h-full items-center justify-start m-auto w-full">
            <div className="flex flex-col md:gap-10 gap-[577px] items-center justify-start w-full">
              ...
              <DesktopThirteenImage26 className="md:h-[2141px] h-[884px] relative w-full" />
            </div>
          </div>
